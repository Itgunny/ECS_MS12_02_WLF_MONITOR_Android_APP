...
public class MainBLeftUpMachineStatusSelectFragment2 extends ParentFragment{
	//CONSTANT////////////////////////////////////////
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRoot = inflater.inflate(R.layout.leftup_main_b_machinestatus_select2, null);
		InitResource();
		InitValuables();
		InitButtonListener();
		ParentActivity.StartBackHomeTimer();
		ParentActivity.ScreenIndex = ParentActivity.SCREEN_STATE_MAIN_B_LEFTUP_MACHINESTATUS2;
