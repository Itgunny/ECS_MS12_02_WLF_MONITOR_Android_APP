...
public class MainBLeftUpMachineStatusSelectFragment3 extends ParentFragment{
	//CONSTANT////////////////////////////////////////
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		TAG = "MainBLeftUpMachineStatusSelect2Fragment";
		Log.d(TAG, "onCreateView");
		mRoot = inflater.inflate(R.layout.leftup_main_b_machinestatus_select3, null);
		InitResource();
		InitValuables();
		InitButtonListener();
		ParentActivity.StartBackHomeTimer();
		ParentActivity.ScreenIndex = ParentActivity.SCREEN_STATE_MAIN_B_LEFTUP_MACHINESTATUS3;
	...
	protected void InitResource() {
		...
		if(Build.VERSION.SDK_INT <= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1){		
			...
			radioFrontAxleTemp = (RadioButton)mRoot.findViewById(R.id.radioButton_leftup_main_b_machinestatus_select_frontaxletemp);
			radioFrontAxleTemp.setPadding(90, 0, 0, 0);
			radioFrontAxleTemp.setText(getString(ParentActivity.getResources().getString(R.string.Front_Axle_Temp), 144));
			ParentActivity.setMarqueeRadio(radioFrontAxleTemp);
			
			radioRearAxleTemp = (RadioButton)mRoot.findViewById(R.id.radioButton_leftup_main_b_machinestatus_select_rearaxletemp);
			radioRearAxleTemp.setPadding(90, 0, 0, 0);
			radioRearAxleTemp.setText(getString(ParentActivity.getResources().getString(R.string.Rear_Axle_Temp), 145));
			ParentActivity.setMarqueeRadio(radioRearAxleTemp);
		} else {
			radioHYDTemp = (RadioButton)mRoot.findViewById(R.id.radioButton_leftup_main_b_machinestatus_select_hydtemp);
			radioHYDTemp.setText(getString(ParentActivity.getResources().getString(R.string.HYD_Temp), 111));
			ParentActivity.setMarqueeRadio(radioHYDTemp);
