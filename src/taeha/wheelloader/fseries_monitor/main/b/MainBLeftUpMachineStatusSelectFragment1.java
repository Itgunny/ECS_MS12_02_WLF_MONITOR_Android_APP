...
public class MainBLeftUpMachineStatusSelectFragment1 extends ParentFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		TAG = "MainBLeftUpMachineStatusSelect1Fragment";
		Log.d(TAG, "onCreateView");
		mRoot = inflater.inflate(R.layout.leftup_main_b_machinestatus_select1, null);
		InitResource();
		InitValuables();
		InitButtonListener();

		ParentActivity.ScreenIndex = ParentActivity.SCREEN_STATE_MAIN_B_LEFTUP_MACHINESTATUS1;
