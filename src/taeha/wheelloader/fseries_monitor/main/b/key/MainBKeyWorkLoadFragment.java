...
public class MainBKeyWorkLoadFragment extends ParentFragment{
	...
	protected void InitResource() {
		...
		textViewOK = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_low_ok);
		textViewOK.setText(getString(ParentActivity.getResources().getString(R.string.OK), 15));
		textViewCancel = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_low_cancel);
		textViewCancel.setText(getString(ParentActivity.getResources().getString(R.string.Cancel), 16));
		textViewDefault = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_low_default);
		textViewDefault.setText(getString(ParentActivity.getResources().getString(R.string.Default), 25));
		
		textviewWeighingSystemModeTitle = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_accumulation_title);
		textviewWeighingSystemModeTitle.setText(getString(ParentActivity.getResources().getString(R.string.Weighing_System_Mode), 169));
		textViewWeighingDisplayTitle = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_display_title);
		textViewWeighingDisplayTitle.setText(getString(ParentActivity.getResources().getString(R.string.Weighing_Display), 170));
		textViewErrorDetectTitle = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_errordetect_title);
		textViewErrorDetectTitle.setText(getString(ParentActivity.getResources().getString(R.string.Error_Detection), 171));
		
		textviewWeighingSystemModeData = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_accumulation_data);
		textViewWeighingDisplayData = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_display_data);
		textViewErrorDetectData = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_errordetect_data);
		
		textViewPressureCalibration = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_calibration);
		textViewPressureCalibration.setText(getString(ParentActivity.getResources().getString(R.string.Boom_Pressure_Calibration), 172));
		textViewInitialization = (TextFitTextView)mRoot.findViewById(R.id.textView_key_main_b_workload_initialization);
