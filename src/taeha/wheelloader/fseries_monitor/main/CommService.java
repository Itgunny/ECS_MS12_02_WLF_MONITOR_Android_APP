...
public class CommService extends Service{
	...
	public native void Close_UART3();				// UART 1�� close ��
	...
	public static void KeyButtonCallBack(int Data){
		try {
			...
			case CAN1CommManager.MENU:
				...
				if(GetScreenTopFlag() == true)	// Ÿ apk���� �Ҹ� 2�� �︲
			...
			case CAN1CommManager.ESC:
				...
				{
					CAN1Comm.Callback_KeyButton(Data);
					SoundPoolKeyButton.play(SoundID, fVolume, fVolume, 0, 0, 1);		// Ÿ apk���� �Ҹ� 2�� �︲
