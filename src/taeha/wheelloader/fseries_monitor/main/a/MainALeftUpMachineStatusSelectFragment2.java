...
public class MainALeftUpMachineStatusSelectFragment2 extends ParentFragment{
	//CONSTANT////////////////////////////////////////
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		TAG = "MainALeftUpMachineStatusSelect2Fragment";
		Log.d(TAG, "onCreateView");
		mRoot = inflater.inflate(R.layout.left_main_a_machinestatus_select2, null);
		InitResource();
		InitValuables();
		InitButtonListener();
		ParentActivity.StartBackHomeTimer();
		ParentActivity.ScreenIndex = ParentActivity.SCREEN_STATE_MAIN_A_LEFTUP_MACHINESTATUS2;
	...
	protected void InitResource() {
		...
		textViewOK = (TextFitTextView)mRoot.findViewById(R.id.textView_leftup_main_a_machinestatus_select_ok);
