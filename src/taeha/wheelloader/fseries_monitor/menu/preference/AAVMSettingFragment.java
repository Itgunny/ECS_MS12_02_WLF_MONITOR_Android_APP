...
public class AAVMSettingFragment extends ParentFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ParentActivity._MenuBaseFragment._MenuInterTitleFragment.SetTitleText(ParentActivity.getResources().getString(string.AAVM_Setting), 506);
	...
	protected void InitResource() {
		...
		textViewReverseCameraAAVM.setText(getString(ParentActivity.getResources().getString(string.AAVM_Type_In_Reverse_Mode), 507));
