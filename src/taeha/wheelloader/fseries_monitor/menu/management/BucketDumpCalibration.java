...
public class BucketDumpCalibration extends ParentFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ParentActivity._MenuBaseFragment._MenuInterTitleFragment.SetTitleText(ParentActivity.getString(string.Bucket_Dump_Speed_Calibration), 475);
	...
	protected void InitResource() {
		...
		textViewDesText1.setText(getString(ParentActivity.getResources().getString(R.string.Bucket_Dump_Calibration_Order1), 478));
		textViewDesText2 = (TextView)mRoot.findViewById(R.id.textView_menu_body_management_calibration_bucket_dump_main_step_2);
		textViewDesText2.setText(getString(ParentActivity.getResources().getString(R.string.Bucket_Dump_Calibration_Order2), 479));
		textViewDesText3 = (TextFitTextView)mRoot.findViewById(R.id.textView_menu_body_management_calibration_bucket_dump_main_step_3);
		textViewDesText3.setText(getString(ParentActivity.getResources().getString(R.string.Bucket_Dump_Calibration_Order3), 480));
		textViewDesText4 = (TextFitTextView)mRoot.findViewById(R.id.textView_menu_body_management_calibration_bucket_dump_main_step_4);
		textViewDesText4.setText(getString(ParentActivity.getResources().getString(R.string.Bucket_Dump_Calibration_Order4), 481));
		textViewOrder5 = (TextView)mRoot.findViewById(R.id.textView_menu_body_management_calibration_bucket_dump_main_order_5);
		textViewDesText5 = (TextFitTextView)mRoot.findViewById(R.id.textView_menu_body_management_calibration_bucket_dump_main_step_5);
		textViewDesText5.setText(getString(ParentActivity.getResources().getString(R.string.Engine_Mode_Set_P_Mode_For_Calibration), 473)); 
		...
		textViewBoomPositionTitle.setText("* " + getString(ParentActivity.getResources().getString(R.string.Boom_Position), 476) + " : ");
		...
		textViewBucketPositionTitle.setText("* " + getString(ParentActivity.getResources().getString(R.string.Bucket_Position), 477) + " : ");
	...
	private void BucketPosition(TextView textData, int Data) {
		if(Data == 1){
			textData.setText(getString(ParentActivity.getResources().getString(string.Roll_Back), 483));
			textData.setTextColor(Color.BLACK);
			textData.setBackgroundColor(Color.RED);
		}else if(Data == 0){
			textData.setText(getString(ParentActivity.getResources().getString(string.OK), 15));
		...
		if((StatusCnt >= 15)) // 5 Sec ~ 
		{
			if( (Result == CAL1_SUCCESS) ||  (Result == CAL2_SUCCESS) 
				...
				case NORMAL_STATUS:
					break;
				case CAL1_RETRY:
					ParentActivity._BucketDumpCalibrationPopup.setTextTitle(getString(getString(string.Bucket_Dump_Calibration_1_Retry), 485));
				...
				case CAL1_SUCCESS:
					Order = 1;
					Order2Display();
					ParentActivity._BucketDumpCalibrationPopup.setTextTitle(getString(getString(string.Bucket_Dump_Calibration_1_Success), 486));
					ParentActivity._BucketDumpCalibrationPopup.setExitFlag(false);
					ParentActivity.showBuckDumpCalibrationResult();
					Log.d(TAG,"CAL1_SUCCESS");
					break;
				case CAL2_RETRY:
					ParentActivity._BucketDumpCalibrationPopup.setTextTitle(getString(getString(string.Bucket_Dump_Calibration_2_Retry), 487));
					ParentActivity._BucketDumpCalibrationPopup.setExitFlag(false);
					...
					break;
				case CAL2_SUCCESS:
					ParentActivity._BucketDumpCalibrationPopup.setTextTitle(getString(getString(string.Bucket_Dump_Calibration_2_Success), 488));
					ParentActivity._BucketDumpCalibrationPopup.setExitFlag(true);
					ParentActivity.showBuckDumpCalibrationResult();
					Log.d(TAG,"CAL2_SUCCESS");
					break;
				case TIMER_OVER_ERROR:
					ParentActivity._BucketDumpCalibrationPopup.setTextTitle(getString(getString(string.Calibration_Fail_Time_Over), 489));
					ParentActivity._BucketDumpCalibrationPopup.setExitFlag(false);
					ParentActivity.showBuckDumpCalibrationResult();
					Log.d(TAG,"TIMER_OVER_ERROR");
					break;
				case BOOM_POSITION_ERROR:
					ParentActivity._BucketDumpCalibrationPopup.setTextTitle(getString(getString(string.Calibration_Fail_Boom_Position_Error), 490));
					ParentActivity._BucketDumpCalibrationPopup.setExitFlag(false);
					ParentActivity.showBuckDumpCalibrationResult();
					Log.d(TAG,"BOOM_POSITION_ERROR");
					break;
				case BUCKET_POSITION_ERROR:
					ParentActivity._BucketDumpCalibrationPopup.setTextTitle(getString(getString(string.Calibration_Fail_Bucket_Position_Error), 491));
					ParentActivity._BucketDumpCalibrationPopup.setExitFlag(false);
					ParentActivity.showBuckDumpCalibrationResult();
				...
				case ENGINE_RPM_ERROR:
					ParentActivity._BucketDumpCalibrationPopup.setTextTitle(getString(getString(string.Calibration_Fail_Engine_Rpm_Error), 492));
					ParentActivity._BucketDumpCalibrationPopup.setExitFlag(false);
					ParentActivity.showBuckDumpCalibrationResult();
					Log.d(TAG,"ENGINE_RPM_ERROR");
					break;
				case LEVEL_POSITION_ERROR:
					ParentActivity._BucketDumpCalibrationPopup.setTextTitle(getString(getString(string.Calibration_Fail_Lever_Position_Error), 493));
					ParentActivity._BucketDumpCalibrationPopup.setExitFlag(false);
					ParentActivity.showBuckDumpCalibrationResult();
