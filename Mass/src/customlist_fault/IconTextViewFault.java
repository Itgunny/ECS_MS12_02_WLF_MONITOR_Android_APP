...
public class IconTextViewFault extends LinearLayout {
	...
	IconTextItemFault aItem;
	
	public IconTextViewFault(Context context, IconTextItemFault aItem) {
		super(context);
		...
		// Set Icon
		mIcon = (ImageView) findViewById(R.id.imageViewInfoIcon_fault);
		mIcon.setImageDrawable(aItem.getIcon());
		
		
		// Set Text 01
		mTextFirst = (TextView) findViewById(R.id.textViewFirst_fault);
		mTextFirst.setText(aItem.getData(0));
		mTextFirst.setTextColor(aItem.getFirstTextColor());
	
		// Set Text 02
		mTextSecond = (TextView) findViewById(R.id.textViewSecond_fault);
		mTextSecond.setText(aItem.getData(1));
		
		
		// Set Text 03
		mTextThird = (TextView) findViewById(R.id.textViewThrid_fault);
	...
	public IconTextItemFault getIconTextItem()
	{
		return aItem;
	}
