...
public class MachineMonitoringFragment2 extends ParentFragment{
	//CONSTANT////////////////////////////////////////
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		 TAG = "MachineMonitoringFragment2";
		Log.d(TAG, "onCreateView");
		mRoot = inflater.inflate(R.layout.menu_body_monitoring_machinemonitoring2, null);
		InitResource();
		InitValuables();
		InitButtonListener();
		
		ParentActivity.ScreenIndex = ParentActivity.SCREEN_STATE_MENU_MONITORING_MACHINEMONITORING_2;
	...
	public void HYDDisplay(int _data, int _status, int _unit){
		...
		if(_status == CAN1CommManager.DATA_STATE_LAMP_ON){
			...
			layoutHYD.setBackgroundResource(R.drawable.menu_information_monitoring_block_warning_61);
		}else{
			...
			layoutHYD.setBackgroundResource(R.drawable.menu_information_monitoring_block_61);
		}
	}
	public void BatteryDisplay(int _data, int _status){
		...
		if(_status == CAN1CommManager.DATA_STATE_LAMP_ON){
			...
			layoutBatt.setBackgroundResource(R.drawable.menu_information_monitoring_block_warning_61);
		}else{
			...
			layoutBatt.setBackgroundResource(R.drawable.menu_information_monitoring_block_61);
		}
	}
	public void CoolantDisplay(int _data, int _status, int _unit){
		...
		if(_status == CAN1CommManager.DATA_STATE_LAMP_ON){
			...
			layoutCoolant.setBackgroundResource(R.drawable.menu_information_monitoring_block_warning_61);
		}else{
			...
			layoutCoolant.setBackgroundResource(R.drawable.menu_information_monitoring_block_61);
		}
	}
	public void TMOilDisplay(int _data, int _status, int _unit){
		...
		if(_status == CAN1CommManager.DATA_STATE_LAMP_ON){
			...
			layoutTMOil.setBackgroundResource(R.drawable.menu_information_monitoring_block_warning_61);
		}else{
			...
			layoutTMOil.setBackgroundResource(R.drawable.menu_information_monitoring_block_61);
		}
	}
	public void FrontAxleDisplay(int _data, int _status, int _unit){
		...
		if(_status == CAN1CommManager.DATA_STATE_LAMP_ON){
			...
			layoutFrontAxle.setBackgroundResource(R.drawable.menu_information_monitoring_block_warning_61);
		}else{
			...
			layoutFrontAxle.setBackgroundResource(R.drawable.menu_information_monitoring_block_61);
		}
	}
	/////////////////////////////////////////////////////////////////////
