...
public class UnitFragment extends ParentFragment{
	...
	public void TypeDisplay(int _data){
		...
		layoutTemp.setClickable(clickable);
		layoutFuel.setClickable(clickable);
		layoutWeight.setClickable(clickable);
		layoutSpeed.setClickable(clickable);
		layoutPressure.setClickable(clickable);
	}
