...
public class ServiceMenuSensorMonitoringHiddenFragment extends ParentFragment{
	...
	protected void InitResource() {
		...
		textViewControlEpprTitle.setText(getString(ParentActivity.getResources().getString(string.Max_Control_Fan_Speed), 494));
		...
		textViewControlEpprData.setText(getString(ParentActivity.getResources().getString(string.Max_Mode), 495));
...
//			Log.d(TAG, "Set_CoolingFanReverseManual_PGN61184_61(3)");
	...
	public void SetMaxControlFanSpeed(int Data){
		...
		case CAN1CommManager.DATA_STATE_OFF:
			textViewControlEpprData.setText(" " + getString(ParentActivity.getResources().getString(string.Max_Mode), 495) + " : " + getString(ParentActivity.getResources().getString(R.string.OFF), 98));
			imgBtnControlUp.setClickable(false);
			imgBtnControlDown.setClickable(false);
			imgBtnControlUp.setAlpha((float)0.5);
			imgBtnControlDown.setAlpha((float)0.5);
		...
		case CAN1CommManager.DATA_STATE_ON:
			textViewControlEpprData.setText(" " + getString(ParentActivity.getResources().getString(string.Max_Mode), 495) + " : " + getString(ParentActivity.getResources().getString(R.string.ON), 97));
			imgBtnControlUp.setClickable(true);
			imgBtnControlDown.setClickable(true);
			imgBtnControlUp.setAlpha((float)1);
			imgBtnControlDown.setAlpha((float)1);
		...
		case CAN1CommManager.DATA_STATE_NOTAVAILABLE:
			textViewControlEpprData.setText(" " + getString(ParentActivity.getResources().getString(string.Not_Available), 496));
			break;
		default:
			break;
		}		
