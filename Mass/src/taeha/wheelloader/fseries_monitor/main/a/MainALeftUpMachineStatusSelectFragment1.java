...
public class MainALeftUpMachineStatusSelectFragment1 extends ParentFragment{
	//CONSTANT////////////////////////////////////////
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		TAG = "MainALeftUpMachineStatusSelect1Fragment";
		Log.d(TAG, "onCreateView");
		mRoot = inflater.inflate(R.layout.left_main_a_machinestatus_select1, null);
		InitResource();
		InitValuables();
		InitButtonListener();
		ParentActivity.StartBackHomeTimer();
		ParentActivity.ScreenIndex = ParentActivity.SCREEN_STATE_MAIN_A_LEFTUP_MACHINESTATUS1;
