...
typedef struct
{
	...
	unsigned char	CoolingFanMaxSpeedCurrentAdjust:2; //++ --, 160523 cjg
	unsigned char 	DM0:4;
...
typedef struct
{
	unsigned char	DateAndTime_941[6];
	unsigned char 	DayOfTheWeek_942:4;
	unsigned char 	reserved:4;
	unsigned char 	LocalHourOffset_951;
}__attribute__((packed)) DATE_AND_TIME_65346;
// --, 161116 cjg
typedef struct
{
	unsigned char	ESLMode_820:2;
	...
	unsigned char	ESLInterval_825;
	// ++, 161116 cjg
	unsigned char 	AlarmMessageIndex_TBD;

	unsigned char 	OperationLimitRequest_TBD;

	unsigned char	OperationLimitStatus:2;
...
typedef struct
{
	unsigned char OperationLimitStatus_TBD:2;
	unsigned char Authentication_attemps_TBD:3;
	unsigned char reserved:3;

	unsigned char reserved1[7];

}__attribute__((packed)) Unlock_Result_65448;
// --, 161116 cjg
// ++, 150327 bwk
typedef struct
{
